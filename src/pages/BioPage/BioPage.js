    ...
    return (
        <div className={styles.MainBioPage}>
            <div className={styles.widthBar}>
                <Header />
                <div id="Home" className={styles.bioPage}>
                    <div>
                    ...
                    <hr className={styles.line} />
                    <div id="title" className={styles.projectInfo}>
                        ...
                        <hr className={styles.line} /><a className={styles.return} href="#Projects">BACK TO PROJECTS</a>
                    ...
                    <div className={styles.contactBox}>
                        ...
                        <div className={styles.emailMe}>
                            ...
                            <a className={styles.downloadResume} target="_blank" href="https://drive.google.com/file/d/1nB9fI4ZNwQsUhOoT5rKcOr3JAgUR1bzh/view?usp=pdf">Download Resume!</a>
                            <hr className={styles.lineWhite} />
                        </div>
